...
public class ControllerTela2 implements Initializable{
  ...
  @FXML
  private ChoiceBox <String> choiceBox, choiceBoxSolucao; // Choice box que  sera utilizado para a escolha de posicao das naves
  ...
  private int solucao = 0; // Variavel que armazena a solucao esocolhida. 
  ...
  private String [] opcoesSolucao = {"Sem controle de colisao", "Variavel de travamento",  
                                     "Estrita alternancia", "Solucao de Peterson"};
  ...
  *************************************************************** */
  ...
  public void mudarParaTela3(ActionEvent event) throws IOException{
    ...
    solucao = choiceBoxSolucao.getSelectionModel().getSelectedIndex(); // Atribui o indice a opcao escolhida pelo usuario a variavel solucao
    ...
    controllerTela3.configurarTela(escolha, solucao); // Chamada do metodo que recebe a escolha
    controllerTela3.atualizarLabel(choiceBox); // Chamada do metodo que atualiza a label com texto da opcao escolhida
    controllerTela3.getSliderMusica().setValue(1.0); // define volume padrao da musica
  ...
  *************************************************************** */
  ...
  public void initialize(URL url, ResourceBundle rb){
    ...
    choiceBoxSolucao.getItems().addAll(opcoesSolucao);// Adiciona o array de opcoes de inicializacao a choiceBox
    choiceBoxSolucao.setValue(opcoesSolucao[solucao]);// Seta o valor da choiceBox, a variavel 'escolha' eh passada como indice
